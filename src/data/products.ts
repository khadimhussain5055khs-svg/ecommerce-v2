...
export const products: Product[] = [
  {
    ...
    stockSold: 0,
    availableStock: 1,
    images: ['https://images.unsplash.com/photo-1600180758895-dd5b60f4aded?w=800&q=80'],
    description: 'Authentic Jordan 1 Mid Chicago in Euro 44-45 (Pakistani 10/11). Iconic red, white, and black colorway with premium leather.',
